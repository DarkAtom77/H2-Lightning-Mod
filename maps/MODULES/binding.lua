hero_mt = {
	__newindex = function (table, key, value)
		...
		elseif k == "attack" then
			SetPrimarySkill(t, PRIMARY_SKILL_ATTACK)
		elseif k == "defense" then
			SetPrimarySkill(t, PRIMARY_SKILL_DEFENSE)
		elseif k == "spellpower" then
			SetPrimarySkill(t, PRIMARY_SKILL_SPELLPOWER)
		elseif k == "knowledge" then
			SetPrimarySkill(t, PRIMARY_SKILL_KNOWLEDGE)
		else
